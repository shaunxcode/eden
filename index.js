...
(function() {
  var $, addToEnv, eden, edn, parseTag, prepTags, _,
  ...
  eden = function(str, options, onCreate) {
    ...
    env = {};
    tags = [];
    reifyOptions = function(options, env, listeners, path) {
    ...
    handleTags = function(tagList, appendTo, isRoot) {
      var $tag, arrOptions, klass, listenTo, reified, tag, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
      if (isRoot == null) {
        isRoot = false;
      }
